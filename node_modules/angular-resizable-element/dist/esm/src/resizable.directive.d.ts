import { Renderer, ElementRef, OnInit, AfterViewInit, EventEmitter, QueryList, OnDestroy, NgZone } from '@angular/core';
...
export declare class Resizable implements OnInit, OnDestroy, AfterViewInit {
     ...
     * @private
     */
    constructor(renderer: Renderer, elm: ElementRef, zone: NgZone);
    /**
     * @private
     */
    ngOnInit(): void;

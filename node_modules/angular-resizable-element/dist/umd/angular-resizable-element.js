(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@angular/core"), require("rxjs/observable/merge"), require("rxjs/add/operator/filter"), require("rxjs/add/operator/map"), require("rxjs/add/operator/mergeMap"), require("rxjs/add/operator/pairwise"), require("rxjs/add/operator/take"), require("rxjs/add/operator/takeUntil"), require("rxjs/Subject"));
	else if(typeof define === 'function' && define.amd)
		define(["@angular/core", "rxjs/observable/merge", "rxjs/add/operator/filter", "rxjs/add/operator/map", "rxjs/add/operator/mergeMap", "rxjs/add/operator/pairwise", "rxjs/add/operator/take", "rxjs/add/operator/takeUntil", "rxjs/Subject"], factory);
	else if(typeof exports === 'object')
		exports["angularResizableElement"] = factory(require("@angular/core"), require("rxjs/observable/merge"), require("rxjs/add/operator/filter"), require("rxjs/add/operator/map"), require("rxjs/add/operator/mergeMap"), require("rxjs/add/operator/pairwise"), require("rxjs/add/operator/take"), require("rxjs/add/operator/takeUntil"), require("rxjs/Subject"));
	else
		root["angularResizableElement"] = factory(root["ng"]["core"], root["rx"]["Observable"]["merge"], root["rx"]["Observable"], root["rx"]["Observable"], root["rx"]["Observable"], root["rx"]["Observable"], root["rx"]["Observable"], root["rx"]["Observable"], root["rx"]["Subject"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_9__, __WEBPACK_EXTERNAL_MODULE_10__, __WEBPACK_EXTERNAL_MODULE_11__) {
...
function getNewBoundingRectangle(startingRect, edges, mouseX, mouseY) {
    var newBoundingRect = {
...
function getResizeEdges(_a) {
    var mouseX = _a.mouseX, mouseY = _a.mouseY, elm = _a.elm, allowedEdges = _a.allowedEdges, cursorPrecision = _a.cursorPrecision;
    var elmPosition = elm.nativeElement.getBoundingClientRect();
    var edges = {};
    if (allowedEdges.left &&
        isNumberCloseTo(mouseX, elmPosition.left, cursorPrecision) &&
        isWithinBoundingY({ mouseY: mouseY, rect: elmPosition })) {
        edges.left = true;
    }
    ...
    if (allowedEdges.top &&
        ...
        isWithinBoundingX({ mouseX: mouseX, rect: elmPosition })) {
        edges.top = true;
    }
...
var Resizable = (function () {
    ...
    Resizable.prototype.ngOnInit = function () {
        ...
        this.mousemove.subscribe(function (_a) {
            ...
            _this.renderer.setElementClass(_this.elm.nativeElement, RESIZE_ACTIVE_CLASS, !!currentResize);
            _this.renderer.setElementClass(_this.elm.nativeElement, RESIZE_LEFT_HOVER_CLASS, resizeEdges.left === true);
            _this.renderer.setElementClass(_this.elm.nativeElement, RESIZE_RIGHT_HOVER_CLASS, resizeEdges.right === true);
            _this.renderer.setElementClass(_this.elm.nativeElement, RESIZE_TOP_HOVER_CLASS, resizeEdges.top === true);
            _this.renderer.setElementClass(_this.elm.nativeElement, RESIZE_BOTTOM_HOVER_CLASS, resizeEdges.bottom === true);
        });
        ...
        this.mousedown.map(function (_a) {
            ...
            if (_this.enableGhostResize) {
                ...
                _this.renderer.setElementStyle(currentResize.clonedNode, 'position', _this.ghostElementPositioning);
                ...
                _this.renderer.setElementStyle(currentResize.clonedNode, 'cursor', getResizeCursor(currentResize.edges, resizeCursors));
            }
            _this.zone.run(function () {
        ...
        this.mouseup.subscribe(function () {
            if (currentResize) {
                _this.renderer.setElementClass(_this.elm.nativeElement, RESIZE_ACTIVE_CLASS, false);
                _this.zone.run(function () {
    ...
    Resizable.prototype.onMousedown = function (mouseX, mouseY) {
        var _this = this;
        this.zone.runOutsideAngular(function () {
            _this.mousedown.next({ mouseX: mouseX, mouseY: mouseY });
        });
    };
    /**
     * @private
    ...
    Resizable.prototype.onMousemove = function (event, mouseX, mouseY) {
        var _this = this;
        this.zone.runOutsideAngular(function () {
            _this.mousemove.next({ mouseX: mouseX, mouseY: mouseY, event: event });
        });
    };
    /**
     * @private
    ...
    Resizable.prototype.onMouseup = function (mouseX, mouseY) {
        var _this = this;
        this.zone.runOutsideAngular(function () {
            _this.mouseup.next({ mouseX: mouseX, mouseY: mouseY });
        });
    };
    __decorate([
        core_1.Input(), 
...
__export(__webpack_require__(3));
 // tslint:disable-line
var resizable_directive_1 = __webpack_require__(2);
exports.Resizable = resizable_directive_1.Resizable; // tslint:disable-line
var resizeHandle_directive_1 = __webpack_require__(0);
exports.ResizeHandle = resizeHandle_directive_1.ResizeHandle; // tslint:disable-line
